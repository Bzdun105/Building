...
namespace CnControls
{
    ...
    public class SimpleJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
    {
	  ...
	  [Space(15f)]
	  public bool HorisontalInverse;
	  public bool VerticalInverse;
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            var horizontalValue = (HorisontalInverse ? -1 : 1) * Mathf.Clamp(difference.x * _oneOverMovementRange, -1f, 1f);
            var verticalValue = (VerticalInverse ? -1 : 1) * Mathf.Clamp(difference.y * _oneOverMovementRange, -1f, 1f);
